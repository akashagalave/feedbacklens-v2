...
#     actionable = any(k in text for k in actionable_keywords)

#     # 🔥 FINAL LOGIC
#     if actionable and not is_generic:
#         return 1.0

#     if len(text.split()) > 12:  # strong recommendation but no keyword
#         return 0.8
...
#     final_score = round((relevance * 0.5) + (rec_score * 0.5), 2)
...
# EVAL_DATASET = [
#     {
#         "query": "Swiggy refund problems",
#         "company": "swiggy",
#         "expected_themes": ["refund", "money", "payment"]
#     },
#     {
#         "query": "uber pricing issues",
#         "company": "uber",
#         "expected_themes": ["pricing", "surge", "fare"]
#     },
#     {
#         "query": "zomato wrong order",
#         "company": "zomato",
#         "expected_themes": ["wrong", "missing", "order"]
#     },
#     {
#         "query": "why is delivery late",
#         "company": "swiggy",
#         "expected_themes": ["delay", "late", "delivery"]
#     },
#     {
#         "query": "uber driver cancel problem",
#         "company": "uber",
#         "expected_themes": ["cancel", "driver"]
#     },
# ]
...
# # =========================
# # 🔥 IMPROVED RECOMMENDATION SCORING (FIXED)
# # =========================
# def evaluate_recommendations(recommendations):
#     if not recommendations:
#         return 0.0
...
#     # 🚀 strong actionable (NEW - IMPORTANT)
#     strong_patterns = [
#         "auto refund",
#         "real time tracking",
...
#     final_score = round((relevance * 0.6) + (rec_score * 0.4), 2)
#     passed = final_score >= FINAL_PASS
...
#     # 🔥 HARD CASES (IMPORTANT FOR TRUST)
...
def evaluate_case(case):
    ...
    # 🔥 more weight to relevance (IMPORTANT)
